...
public class G_SettingsMenu : MonoBehaviour
{
    ...
    public void LoadSettings(int currentResolutionIndex)
    {
        ...
        public void OpenCloseSettings(Button current)
        {
            if (current.gameObject.name == "CloseSettingsButton")
            {
                settingsMenu.SetActive(false);
                googleLoader.menuOpen = false;
            }

            else if (current.gameObject.name == "OpenSettingsButton")
            {
